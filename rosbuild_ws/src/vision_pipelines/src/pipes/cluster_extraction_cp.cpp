#include "pipes/cluster_extraction.h"
...
void cluster_extraction(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, pcl::ModelCoefficients::Ptr coefficients, pcl::PointIndices::Ptr inliers)
{
...
//      std::cout <<"PointCloud has "<<cloud_plane->points.size()<<" data points."<<std::endl;
  ...
  pcl::removeNaNFromPointCloud(*cloud_f, *cloud_f, i);
